...
<html>
<head>
<title>Welcome to EEC Admin Dashboard</title>
<meta charset="UTF-8">
...
.bgimg-1 {
  ...
  background-image: url("img/adminbanner.png");
  min-height: 100%;
}
...
<div class="w3-top">
  <div class="w3-bar w3-white w3-card" id="myNavbar">
    ...
    <a href="#home" class="w3-bar-item w3-button w3-wide w3-hover-black">ENGLISH ENTHUSIASTS CLUB</a>
    <!-- Right-sided navbar links -->
 
    <div class="w3-right w3-hide-small">
      <a href="#about" class="w3-bar-item w3-button w3-hover-black"><i class="fa fa-info"></i> ABOUT</a>
      <a href="#team" class="w3-bar-item w3-button w3-hover-black"><i class="fa fa-group"></i> TEAM</a>
      <a href="#activity" class="w3-bar-item w3-button w3-hover-black"><i class="fa fa-file"></i> ACTIVITY</a>
      <a href="indexadmin.php" class="w3-bar-item w3-button w3-hover-black"><i class="fa fa-briefcase"></i> ADMIN</a>
      <a href="#membership" class="w3-bar-item w3-button w3-hover-black"><i class="fa fa-star"></i> MEMBERSHIP</a>
      <a href="#gallery" class="w3-bar-item w3-button w3-hover-black"><i class="fa fa-image"></i> GALLERY</a>
      <a href="#contact" class="w3-bar-item w3-button w3-hover-black"><i class="fa fa-envelope"></i> CONTACT</a>
      <a href="logout.php" class="w3-bar-item w3-button w3-hover-black"><i class="fa fa-sign-out"></i></a>
    </div>
...
<header class="bgimg-1 w3-display-container" id="home">
  <div class="w3-display-left w3-text-white" style="padding:48px">
    <span class="w3-jumbo w3-hide-small"><b>Hello, Admin <?php echo $row['last_name']; ?></b></span><br>
    <span class="w3-large">Welcome to Administrator Panel!</span><br>
    <span class="w3-large">Admin All-Stars: Making the Club Journey Effortlessly Exceptional.</span>
  </div> 
...
<!-- Team Section -->
<div class="w3-container w3-black" style="padding:100px 16px" id="team">
...
<h3 class="w3-center"><b>ACTIVITIES BY ENGLISH ENTHUSIASTS CLUB</b></h3>
    ...
    <a href="add_activity.php" class="btn btn-dark mb-3 w3-black w3-hover-white">Add Activity</a>
      ...
      <tbody>
        ...
        ?>
          <tr>
            ...
            <td>
              <a href="edit_activity.php?activity_id=<?php echo $row["activity_id"] ?>" class="link-dark"><i class="fa fa-pencil-square fs-5 me-3"></i></a>
              <a href="delete_activity.php?activity_id=<?php echo $row["activity_id"] ?>" class="link-dark"><i class=" fa fa-trash fs-5"></i></a>
            </td>
          </tr>
        <?php
        }
...
<h3 class="w3-center"><b>MEMBERSHIP FORM OF ENGLISH ENTHUSIASTS CLUB 2024</b></h3>
    ...
    <a href="add_membership.php" class="btn btn-dark mb-3 w3-black w3-hover-white">Add Membership</a>
      ...
      <tbody>
        ...
        ?>
          <tr>
            ...
            <td>
              <a href="edit_membership.php?student_id=<?php echo $row["student_id"] ?>" class="link-dark"><i class="fa fa-pencil-square fs-5 me-3"></i></a>
              <a href="delete_membership.php?student_id=<?php echo $row["student_id"] ?>" class="link-dark"><i class="fa fa-trash fs-5"></i></a>
            </td>
          </tr>
        <?php
        }
      ...
      <tbody>
        ...
        ?>
          <tr>
            ...
            <td>
              <a href="edit_contact.php?contact_id=<?php echo $row["contact_id"] ?>" class="link-dark"><i class="fa fa-pencil-square fs-5 me-3"></i></a>
              <a href="delete_contact.php?contact_id=<?php echo $row["contact_id"] ?>" class="link-dark"><i class="fa fa-trash fs-5"></i></a>
            </td>
          </tr>
        <?php
        }
...
<footer class="w3-center w3-black w3-padding-64">
  <a href="#home" class="w3-button w3-light-grey w3-hover-white"><i class="fa fa-arrow-up w3-margin-right"></i>To the top</a>
  ...
  <p>Powered by <a href="https://www.w3schools.com/w3css/default.asp" style="  text-decoration:none;
    color: white;" title="W3.CSS" target="_blank" class="w3-hover-text-light-grey">w3.css</a></p>
</footer>
